            ...
            >
              <Link href={`/group/${group._id}`} className="block">
                <CardContent className="p-0">
                  ...
                  <div className="p-5 pb-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-xs text-zinc-400 font-['inter-beta']">
                  ...
                  {/* Stats Section */}
                  <div className="px-5 py-4 bg-zinc-900/30 border-y border-white/5">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-zinc-500 uppercase tracking-wider mb-1 font-['inter-beta']">
                          Total Expenses
                        </p>
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-1.5 text-xs font-['inter-beta']">
                  ...
                  <div className="px-5 py-3 flex items-center justify-between text-sm">
                    <span className="text-zinc-500 text-xs font-['inter-beta']">
                      View details
                    </span>
