        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-lg text-zinc-500 leading-relaxed mb-12 max-w-lg">
              Group trips and shared activities often lead to confusion about
              who paid and who owes what. Manual tracking creates stress that
          ...
          <div className="relative">
            ...
            <div className="relative bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-zinc-800">
                ...
                <span className="text-zinc-600 text-xs bg-zinc-800/50 px-2 py-1 rounded">
                  3 members
                </span>
              </div>
              ...
              <div className="space-y-3">
                {[
                  {
                    name: 'Ahmed',
                    msg: 'Paid ₹24,000 for hotel booking',
                    time: '2h ago',
                    amount: '+₹24,000',
                    type: 'credit',
                  },
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 bg-zinc-950/50 rounded-xl border border-zinc-800/50"
                  >
                    ...
                    <div
                      className={`text-sm font-medium ${item.type === 'credit' ? 'text-zinc-300' : 'text-zinc-500'}`}
                    >
                      {item.amount}
                    </div>
                  </div>
