    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 font-inter-reguler">
      <Card className="w-full max-w-md bg-zinc-950 border-white/10">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-inter-bold text-white">Welcome Back</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onLogin)} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-white font-inter-bold">Email</Label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-white font-inter-bold">Password</Label>
                <Link href="/forgot" className="text-xs text-zinc-400 hover:text-white">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <Button type="submit" className="w-full bg-white text-black hover:bg-zinc-200 font-inter-bold" disabled={isLoading}>
